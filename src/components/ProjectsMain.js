...
function ProjectsMain () {
    return (
        <div>
            <div className = 'bg-gradient-to-r from-pink-500 to-orange-500 flex bg-white w-40 mx-auto mb-5 shadow-md rounded-lg p-3'>
            ...
            <div>
                <div className = 'flex bg-white w-full mb-5 shadow-md rounded-lg'>
                    ...
                    <div className = 'w-2/3 p-5'>
                        ...
                        <span className='bg-blue-500 text-white rounded-lg p-2 w-16 text-center mr-2'>Python</span>
            ...
            <div>
                <div className = 'flex bg-white w-full mb-5 shadow-md rounded-lg'>
                    ...
                    <div className = 'w-2/3 p-5'>
                        ...
                        <span className='bg-cyan-500 text-white rounded-lg p-2 w-16 text-center mr-2'>React</span>
